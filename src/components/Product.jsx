...
import { decrementAmount, incrementAmount, removeItem } from "../redux/features/shopSlice";
    ...
    return (<>
      ...
      <div className="max-w-3xl mx-auto py-5 px-3 flex justify-between items-center">
        ...
        <div className="w-1/2">
          ...
          <button onClick={() => dispatch(removeItem({name}))} className="btn btn-sm">Remove</button>
        </div>
